          ...
          <>
            ...
            <View style={s.about}>
              ...
              <Text style={s.aboutBody}>
                Stripe processes the transaction. There are no platform fees beyond
                the standard processing cost. The full balance is forwarded to the
                designated organization on a quarterly cadence. Receipts are
                emailed automatically.
              </Text>
              <Text style={s.aboutBody}>
                The current beneficiary is configured by the platform owner and
                can be reviewed at any time. If you have a specific organization
                you would like the platform to consider, write to the team.
              </Text>
            </View>
          </>
        )}
