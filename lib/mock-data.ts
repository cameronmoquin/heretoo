...
const AUTHORS: Record<string, Post['author'] & { bio: string; age: number; location: string }> = {
  coldpack:          { username: 'coldpack',          display_name: 'Sandy Corvo',        avatar_url: 'https://i.pravatar.cc/150?u=coldpack', cluster_id: 1, bio: 'Catering. Providence. Fifteen years in kitchens nobody photographed.', age: 44, location: 'Providence, RI' },
  longbox:           { username: 'longbox',           display_name: 'Vega',                avatar_url: 'https://i.pravatar.cc/150?u=longbox', cluster_id: 3, bio: 'Homicide. Cold cases on my own time. Still working one from 2009.', age: 51, location: 'Providence, RI' },
  walttwo:           { username: 'walttwo',           display_name: 'Walt Brennan',        avatar_url: 'https://i.pravatar.cc/150?u=walttwo', cluster_id: 2, bio: 'Licensed therapist. I listen for a living. Some things I heard I still carry.', age: 48, location: 'Providence, RI' },
  ninerooms:         { username: 'ninerooms',         display_name: 'Nina Calloway',       avatar_url: 'https://i.pravatar.cc/150?u=ninerooms', cluster_id: 4, bio: 'Art consultant. Providence. I know what things are worth and what they are not.', age: 38, location: 'Providence, RI' },
  drystacker:        { username: 'drystacker',        display_name: 'Mark Dolan',          avatar_url: 'https://i.pravatar.cc/150?u=drystacker', cluster_id: 1, bio: 'Construction. Federal Hill twenty years. I pull walls that were done wrong and start over.', age: 41, location: 'Providence, RI' },
  clearlyright:      { username: 'clearlyright',      display_name: 'Pat Reilly',          avatar_url: 'https://i.pravatar.cc/150?u=clearlyright', cluster_id: 5, bio: 'Risk management. Former city auditor. I make cases. Mostly correct ones.', age: 45, location: 'Providence, RI' },
  sevenpetalslena:   { username: 'sevenpetalslena',   display_name: 'Lena Park',           avatar_url: 'https://i.pravatar.cc/150?u=sevenpetalslena', cluster_id: 2, bio: 'Runs Seven Petals Wellness on Westminster. Ten years. Still here.', age: 39, location: 'Providence, RI' },
  thirdfloor:        { username: 'thirdfloor',        display_name: 'Mike Walden',         avatar_url: 'https://i.pravatar.cc/150?u=thirdfloor', cluster_id: 1, bio: 'Providence Fire. Cardiac EMT. Federal Hill kid. I know how systems fail.', age: 38, location: 'Providence, RI' },
  purpleshell:       { username: 'purpleshell',       display_name: 'Allen Hazard',        avatar_url: 'https://i.pravatar.cc/150?u=purpleshell', cluster_id: 3, bio: 'Wampum maker. Charlestown. My granddaughter picks the shells. I show her what they mean.', age: 62, location: 'Charlestown, RI' },
  greycoat:          { username: 'greycoat',          display_name: "Charles d'Eon",       avatar_url: 'https://i.pravatar.cc/150?u=greycoat', cluster_id: 4, bio: 'Soldier. Diplomat. The last life is the one I chose. The others were practice.', age: 47, location: 'London, England' },
  thirdparty:        { username: 'thirdparty',        display_name: 'Pierre Beaumarchais', avatar_url: 'https://i.pravatar.cc/150?u=thirdparty', cluster_id: 4, bio: 'Playwright. Watchmaker. The best conversation is the one no one wrote down.', age: 43, location: 'Paris, France' },
  wrongcertain:      { username: 'wrongcertain',      display_name: 'Samuel Goudsmit',     avatar_url: 'https://i.pravatar.cc/150?u=wrongcertain', cluster_id: 5, bio: 'Physicist. I spent three years certain about something that was not true. I am a better scientist for it.', age: 52, location: 'Ann Arbor, MI' },
  fixedloose:        { username: 'fixedloose',        display_name: 'Boris Pash',          avatar_url: 'https://i.pravatar.cc/150?u=fixedloose', cluster_id: 5, bio: 'Army intelligence. The objective stays fixed. The method stays loose. Thirty years of that.', age: 55, location: 'Washington, DC' },
  ocracokeborn:      { username: 'ocracokeborn',      display_name: 'Mary Ormond',         avatar_url: 'https://i.pravatar.cc/150?u=ocracokeborn', cluster_id: 3, bio: 'Outer Banks. I have been called many things. Most of them by men who did not stay long enough to be right.', age: 34, location: 'Ocracoke, NC' },
  freemanfirstmate:  { username: 'freemanfirstmate',  display_name: 'Caesar',              avatar_url: 'https://i.pravatar.cc/150?u=freemanfirstmate', cluster_id: 5, bio: 'Free man. First mate. I chose this ship knowing exactly what it was.', age: 31, location: 'At sea' },
  notmyalpacas:      { username: 'notmyalpacas',      display_name: 'Dillon Marsh',        avatar_url: 'https://i.pravatar.cc/150?u=notmyalpacas', cluster_id: 2, bio: 'Event coordinator. Atlantic Consulting. Getting through December one catastrophe at a time.', age: 29, location: 'Newport, RI' },
  mosssword:         { username: 'mosssword',         display_name: 'Jude',                avatar_url: 'https://i.pravatar.cc/150?u=mosssword', cluster_id: 4, bio: 'Adventurer. Raccoon wrangler. Mosspunkia forever.', age: 12, location: 'Mosspunkia' },
  softworldsprove:   { username: 'softworldsprove',   display_name: 'Fardo Mowkwin',       avatar_url: 'https://i.pravatar.cc/150?u=softworldsprove', cluster_id: 3, bio: 'I was right about everything. The soft world proved it. I did not enjoy being right.', age: 0, location: 'The Deep Forest' },
};
...
export const MOCK_POSTS: Post[] = [
  // 1 — fire scene, triple-decker
  { id: 'post-001', author_id: 'thirdfloor', content: 'Pulled a man out of a Federal Hill triple-decker at 3am Tuesday. He was in his nineties. Every photograph he had ever owned was laid out on the kitchen table in rows. I do not know why. Some things you do not ask about at 3am.', media_type: 'photo', photo_urls: ['https://picsum.photos/seed/heretoo1/600/400'], mux_playback_id: null, mux_thumbnail_url: null, video_duration_seconds: null, bridging_score: 0.88, total_engagements: 214, cluster_reach: 5, cross_cluster_ratio: 0.81, topic_tags: ['Community', 'First Responders'], is_position: false, position_claim: null, position_steelman: null, position_common_ground: null, created_at: '2026-04-13T09:00:00Z', author: author('thirdfloor'), user_engagements: ['agree'] },
  // 2 — shell on the beach
  { id: 'post-002', author_id: 'purpleshell', content: 'My granddaughter found a shell this morning and held it out to me. Papa look, wampum. She does not know yet what she is holding. Three hundred years of something. I did not explain it. She already had the important part.', media_type: 'photo', photo_urls: ['https://picsum.photos/seed/heretoo2/600/400'], mux_playback_id: null, mux_thumbnail_url: null, video_duration_seconds: null, bridging_score: 0.94, total_engagements: 312, cluster_reach: 6, cross_cluster_ratio: 0.87, topic_tags: ['Culture & Heritage', 'Family'], is_position: false, position_claim: null, position_steelman: null, position_common_ground: null, created_at: '2026-04-13T08:30:00Z', author: author('purpleshell'), user_engagements: ['agree', 'bridge'] },
  // 3 — chef's knife
  { id: 'post-003', author_id: 'coldpack', content: 'The difference between a good knife and a great knife is whether it does exactly what you ask of it. No more. No less. Most things worth having are like this.', media_type: 'photo', photo_urls: ['https://picsum.photos/seed/heretoo3/600/400'], mux_playback_id: null, mux_thumbnail_url: null, video_duration_seconds: null, bridging_score: 0.79, total_engagements: 148, cluster_reach: 5, cross_cluster_ratio: 0.73, topic_tags: ['Food & Cooking', 'Craft'], is_position: false, position_claim: null, position_steelman: null, position_common_ground: null, created_at: '2026-04-13T08:00:00Z', author: author('coldpack'), user_engagements: [] },
  // 4
  ...
  { id: 'post-011', author_id: 'drystacker', content: 'Pulled a forty-year-old dry stack retaining wall on Atwells today. Previous contractor used the wrong stone. Took the whole thing down and started over. Some things you cannot patch. That is not pessimism. That is walls.', media_type: 'photo', photo_urls: ['https://picsum.photos/seed/heretoo11/600/400'], mux_playback_id: null, mux_thumbnail_url: null, video_duration_seconds: null, bridging_score: 0.76, total_engagements: 142, cluster_reach: 4, cross_cluster_ratio: 0.68, topic_tags: ['Craft', 'Local Community'], is_position: false, position_claim: null, position_steelman: null, position_common_ground: null, created_at: '2026-04-13T03:30:00Z', author: author('drystacker'), user_engagements: ['agree'] },
  // 12
  ...
  // 25 — pirate ship / sea
  { id: 'post-025', author_id: 'ocracokeborn', content: 'Blackbeard did not inspire fear. He designed it. Piece by piece. A man who inspires fear has it by accident. A man who designs it is doing something deliberate and considered and worth understanding on its own terms.', media_type: 'photo', photo_urls: ['https://picsum.photos/seed/heretoo25/600/400'], mux_playback_id: null, mux_thumbnail_url: null, video_duration_seconds: null, bridging_score: 0.80, total_engagements: 187, cluster_reach: 5, cross_cluster_ratio: 0.73, topic_tags: ['History', 'Leadership'], is_position: false, position_claim: null, position_steelman: null, position_common_ground: null, created_at: '2026-04-12T20:00:00Z', author: author('ocracokeborn'), user_engagements: [] },
  // 26
  ...
  // 30 — yoga / community space
  { id: 'post-030', author_id: 'sevenpetalslena', content: 'Ten years ago I had a yoga studio. Now I have a community. The difference took me seven years to understand. Three more to accept. I am still working on what comes next.', media_type: 'photo', photo_urls: ['https://picsum.photos/seed/heretoo30/600/400'], mux_playback_id: null, mux_thumbnail_url: null, video_duration_seconds: null, bridging_score: 0.86, total_engagements: 201, cluster_reach: 5, cross_cluster_ratio: 0.79, topic_tags: ['Community', 'Health & Wellness'], is_position: false, position_claim: null, position_steelman: null, position_common_ground: null, created_at: '2026-04-12T17:30:00Z', author: author('sevenpetalslena'), user_engagements: ['agree'] },
  // 31
  ...
  // 37 — video: ocean waves
  { id: 'post-037', author_id: 'ocracokeborn', content: 'The sound the Atlantic makes at four in the morning is not what you think. It is not peaceful. It is working.', media_type: 'video', photo_urls: null, mux_playback_id: 'qxBKpMHVknic4mvbRR00P802VmYWjflhEw', mux_thumbnail_url: 'https://image.mux.com/qxBKpMHVknic4mvbRR00P802VmYWjflhEw/thumbnail.jpg', video_duration_seconds: 24, bridging_score: 0.79, total_engagements: 167, cluster_reach: 4, cross_cluster_ratio: 0.71, topic_tags: ['Sea', 'Nature'], is_position: false, position_claim: null, position_steelman: null, position_common_ground: null, created_at: '2026-04-12T14:00:00Z', author: author('ocracokeborn'), user_engagements: [] },
  // 38 — video: city at night
  { id: 'post-038', author_id: 'thirdfloor', content: 'Federal Hill at 2am. The shift nobody talks about. This is when the city tells you what it actually is.', media_type: 'video', photo_urls: null, mux_playback_id: 'a4nOgR00WZSM02602bseaVUYAmLKo3vpt8', mux_thumbnail_url: 'https://image.mux.com/a4nOgR00WZSM02602bseaVUYAmLKo3vpt8/thumbnail.jpg', video_duration_seconds: 18, bridging_score: 0.85, total_engagements: 201, cluster_reach: 5, cross_cluster_ratio: 0.78, topic_tags: ['Community', 'First Responders'], is_position: false, position_claim: null, position_steelman: null, position_common_ground: null, created_at: '2026-04-12T13:30:00Z', author: author('thirdfloor'), user_engagements: ['agree'] },
];
