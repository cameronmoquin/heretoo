...
export const PARLOR_ESSAYS: ParlorEssay[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'We do not run advertising. There are no sponsored posts and no banner placements and no "this experience is brought to you by." The product is paid for by a small family subscription, five dollars a month, paid by the family for the family. The grandmother never sees a price; the granddaughter does. A platform that does not sell its users sells its product, and we want to sell the product.',
